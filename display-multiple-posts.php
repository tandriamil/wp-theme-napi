...
if (have_posts()) {
	while (have_posts()) {
		...
		//Put all the post in a box, we have to do this way then ...
		echo '<div '; post_class('box col-lg-10 col-lg-push-1 col-ls-pull-1'); echo '>';
		...
		if (has_post_thumbnail()) {
			echo '<div class="post_thumbnail thumbnail">';
			the_post_thumbnail();
			echo '</div>';
		}
